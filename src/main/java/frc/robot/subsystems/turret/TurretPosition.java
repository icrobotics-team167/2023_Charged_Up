...
public record TurretPosition(double pivotAngle, double swivelAngle, double extensionPosition) {
    ...
    public static final TurretPosition HIGH_LEFT  = new TurretPosition(35, -20, 42);
    ...
    public static final TurretPosition MID_LEFT   = new TurretPosition(35, -28, 28);
    ...
    public static final TurretPosition HIGH_GOAL_CUBE_RED  = HIGH_GOAL_CENTER.withSwivel(-9.6);  // positioning for auto
    public static final TurretPosition HIGH_GOAL_CONE_BLUE = HIGH_GOAL_CENTER.withSwivel(-12.5); // positioning for auto
    public static final TurretPosition HIGH_GOAL_CONE_RED  = HIGH_GOAL_CENTER.withSwivel( 12.5); // positioning for auto
