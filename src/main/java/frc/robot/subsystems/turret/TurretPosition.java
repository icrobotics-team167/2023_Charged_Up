...
public record TurretPosition(double pivotAngle, double swivelAngle, double extensionPosition) {
    ...
    public static final TurretPosition HIGH_GOAL = new TurretPosition(37.7, 0, 39.6);
    ...
    public static final TurretPosition PLAYER_STATION = new TurretPosition(0, 0, 3.5);
}
